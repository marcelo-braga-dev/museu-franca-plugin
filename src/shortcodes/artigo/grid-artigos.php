            ...
            while ($query->have_posts()): $query->the_post();
                ...
                <article class="artigo-card" aria-labelledby="ttl-<?= $post_id; ?>">
                    <div class="artigo-cover">
                        <a href="<?= esc_url(mp_get_url_artigo($post_id)); ?>" aria-label="Abrir artigo">
                    ...
                    <a href="<?= esc_url(mp_get_url_artigo($post_id)); ?>">
                        <h3 id="ttl-<?= $post_id; ?>"
...
<!--                        <a class="btn-leia" href="--><?php //= esc_url(mp_get_url_artigo($post_id)); ?><!--">-->
