...
// === Walker para exibir contagem e apontar para página-alvo ===
...
// === Shortcode do menu: [menu_categorias target="/artigos/"] ===
...
add_action('save_post_artigo',  'mp_vertical_category_menu_flush_cache');
